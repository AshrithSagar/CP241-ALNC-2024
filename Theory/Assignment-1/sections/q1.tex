...
\[
    H(p,q) = \frac{1}{2} M_1 {\dot q_1}^2 + \frac{1}{2} M_2 {\dot q_2}^2 + \frac{1}{2} K_1 {q_1}^2 + \frac{1}{2} K {(q_2 - q_1)}^2 + \frac{1}{2} K_2 {q_2}^2
    \tag{1.4}
\]
...
\[
    \begin{aligned}
        \dot q_1 & = \frac{\partial H}{\partial p_1}(p,q) = M_1 \dot q_1                                                                                   \\
        \dot q_2 & = \frac{\partial H}{\partial p_2}(p,q) = M_2 \dot q_2                                                                                   \\
        \dot p_1 & = -\frac{\partial H}{\partial q_1}(p,q) = -\frac{\partial T}{\partial q_1} - \frac{\partial W}{\partial q_1} = -K_1 q_1 + K (q_2 - q_1) \\
        \dot p_2 & = -\frac{\partial H}{\partial q_2}(p,q) = -\frac{\partial T}{\partial q_2} - \frac{\partial W}{\partial q_2} = -K (q_2 - q_1) - K_2 q_2
    \end{aligned}
\]
